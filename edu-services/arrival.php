...
// 3. استدعاء الهيدر المشترك (مع تمرير بادئة المسار إذا كان الهيدر يدعمها، أو استدعاؤه بالطريقة المعتمدة)
...
?>
  ...
  <section class="custom-services py-5 position-relative">
    <?php if (isset($is_admin) && $is_admin): ?>
      <button class="btn btn-sm btn-primary position-absolute top-0 start-0 m-3 shadow-sm rounded-pill px-3 py-2 z-3" data-bs-toggle="modal" data-bs-target="#arrivalHeroModal" title="تعديل الهيدر والصورة">
          <i class="bi bi-pencil-fill ms-1"></i> تعديل القسم
      </button>
    <?php endif; ?>
  ...
  <section class="custom-services-info py-5 position-relative">
    <?php if (isset($is_admin) && $is_admin): ?>
      <button class="btn btn-sm btn-primary position-absolute top-0 start-0 m-3 shadow-sm rounded-pill px-3 py-2 z-3" data-bs-toggle="modal" data-bs-target="#arrivalContentModal" title="تعديل المحتوى والإرشادات">
          <i class="bi bi-pencil-fill ms-1"></i> تعديل المحتوى
      </button>
    <?php endif; ?>
