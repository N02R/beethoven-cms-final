...
?>
  ...
  <section class="custom-services py-5" style="position: relative;">
    ...
    <div class="custom-container">
      <div class="pakeges-hero custom-hero" 
           style="background-image: url('<?php echo htmlspecialchars($path_prefix . ($offers_data['hero_img'] ?? 'assets/img/education/servicesimg10.png')) . '?v=' . time(); ?>'); background-position: <?php echo htmlspecialchars($offers_data['hero_position'] ?? 'center center'); ?>;">
      </div>
    </div>
  </section>
  <!-- custom-services end -->
