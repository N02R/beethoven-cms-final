    ...
    <div class="container-fluid custom-container">
        <div class="row gy-5">
            ...
            <div class="col-12 col-lg-5">
                <img src="<?php echo $path_prefix . ($data['site_logo_path'] ?? 'assets/img/logo.png'); ?>" alt="Logo" class="mb-4">
                <p class="footer-desc"><?php echo htmlspecialchars($data['footer_desc'] ?? ''); ?></p>
            </div>

            <!-- العمود 2: روابط سريعة (مربوط بالـ Menu) -->
        ...
        <div class="foot-bottom d-flex flex-column flex-md-row align-items-center justify-content-between gap-3 pb-4">
            <p class="mb-0 text-center text-md-start">&copy; جميع الحقوق محفوظة | Beethoven City Services</p>
