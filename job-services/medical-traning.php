...
$global_data['job_search_package_page'] = $job_agreements_data;
  ...
  <section class="custom-services py-5" style="position: relative;">
    ...
    <div class="custom-container">
      <div class="coverLetter-hero custom-hero" 
           style="background-image: url('<?php echo $path_prefix . htmlspecialchars($job_agreements_data['hero_img'] ?? 'assets/img/job/servicesimg4.png'); ?>?v=<?php echo time(); ?>'); background-position: <?php echo htmlspecialchars($job_agreements_data['hero_position'] ?? 'center center'); ?>;">
      </div>
    </div>
  </section>
  <!-- custom-services end -->
          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="download-card">
              <div class="download-row">
                ...
                <a class="download-link" href="<?php echo $path_prefix . htmlspecialchars($item['file'] ?? 'assets/files/job_search_agreement.pdf'); ?>" download>Download</a>
              </div>
            </div>
          </div>
        </div>
...
if (isset($is_admin) && $is_admin && file_exists(__DIR__ . '/includes/admin_job_agreements_modals.php')) {
    include_once __DIR__ . '/includes/admin_job_agreements_modals.php';
}
