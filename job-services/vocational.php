...
// 2. تمرير ملف الـ CSS المشترك ديناميكياً ليتم حَقنه داخل الهيدر
$page_css = [
...
?>
  ...
  <div class="custom-container pt-5">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb justify-content-start">
        ...
        <li class="breadcrumb-item" aria-current="page">باقة التدريب المهني</li>
      </ol>
    </nav>
  </div>
  <!-- Breadcrumb end-->
  ...
  <section class="custom-services py-5">
    <div class="custom-container ">
      <div class="coverLetter-hero custom-hero" style="background-image: url('<?php echo $path_prefix; ?>assets/img/job/servicesimg2.png'); background-position: center center;">
      </div>
    </div>
  </section>
  <!-- custom-services end -->
  ...
  <section class="custom-services-info py-5">
    <div class="custom-container">
      <div class="head-info">
        <h2 class="main-text">العروض والإتفاقيات/التدريب والتأهيل المهني "Ausbildung"</h2>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
          <div class="download-card">
            <div class="download-row">
              ...
              <div class="dl-info">
                <div class="dl-title">عرض واتفاقية التدريب والتأهيل المهني</div>
                <div class="dl-sub">Example</div>
              </div>
              <span class="leader d-lg-block d-md-none d-sm-none" aria-hidden="true">.........................................................................................</span>
              <a class="download-link" href="<?php echo $path_prefix; ?>assets/files/ausbildung_agreement.pdf" download>Download</a>
            </div>
          </div>
        </div>
      </div>
