...
use App\Controllers\Services\OffersController;
...
$router->add('GET', 'edu-services/health', [OffersController::class, 'index']);
...
$router->add('POST', 'admin/upload', [UploadController::class, 'upload']);
