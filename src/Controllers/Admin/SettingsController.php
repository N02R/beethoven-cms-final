...
class SettingsController
{
    public function save(): void
    {
        ...
        try {
            ...
            // 0.ب. فحص الصفحات الفردية (تشمل Price List, Medical Specialties, Arrival, Visa, Check, Cover Letter, CV, Motivation, German Lang, English Lang, Offers, Health, Financial, Living Cost, Foundation, Courses)
