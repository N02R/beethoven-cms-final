...
use App\Models\GuideBlogThreeModel;
...
class GuideBlog3Controller {
    public function index(string $lang = 'de'): void {
        ...
        // 2. جلب بيانات الصفحة بطريقة آمنة لمدونة Guide Blog 3
        $raw_guide_data = class_exists('App\Models\GuideBlogThreeModel') ? GuideBlogThreeModel::getGuideData() : [];
        
        // استخراج المصفوفة الداخلية الخاصة بالمدونة الثالثة
        $guide_data = $raw_guide_data['guide_blog3'] ?? $raw_guide_data;
        ...
        // 2. استدعاء الـ View الخاص بصفحة Blog 3
        $view_file = $root_path . '/src/Views/guide/guide-blog3.php';
        ...
        // 3. استدعاء مودلز لوحة التحكم الخاصة بالمدونة الثالثة للمشرفين
        if ($is_admin) {
            $modals_file = $root_path . '/src/Views/guide/includes/admin_guide_blog3_modals.php';
