...
use App\Models\GuideModel; // أو الطريقة المركزية لجلب بيانات الدليل
...
class GuideController {
    public function index(string $lang = 'de'): void {
        ...
        // 1. جلب بيانات الهيدر والفوتر العامة لكل الموقع
        $data = SiteModel::getGlobalData();

        // 2. جلب بيانات الدليل الشامل ودمجها مع البيانات العامة
        // (إذا كنتِ تجلبينها عبر GuideModel أو SiteModel::getGlobalData المخصص)
        $guideData = GuideModel::getGuideData(); 
        ...
        // متغيرات إضافية للـ View
        $path_prefix = '/';
        $page_css = ['/assets/css/style.css'];

        // استخراج المتغيرات لتكون جاهزة داخل الـ View
        extract($data);
