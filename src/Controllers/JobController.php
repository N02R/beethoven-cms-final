...
class JobController
{
    public function index(): void
    {
        try {
            ...
            // استخراج المتغيرات ب valores افتراضية لضمان عدم ظهور أي تحذيرات
            ...
            // تعقيم القيم في حال حدوث خطأ بالسيرفر أو قاعدة البيانات
            $job_hero = [];
        ...
        // مسار ملف الـ View (تأكد أن اسم الملف job.php وليس jobs.php حسب مسار الخطأ لديك)
