...
class BachelorPackageController {
    public function index(string $lang = 'de'): void {
        ...
        // 2. جلب بيانات صفحة باقة البكالوريوس الخاصة
        $global_settings = SiteModel::getSettings();
        $bachelor_data = isset($global_settings['bachelor_package_page']) ? json_decode($global_settings['bachelor_package_page'], true) : [];
        
        $data['bachelor_package_page'] = $bachelor_data;
        ...
        // 2. استدعاء ملف الـ View الخاص بباقة البكالوريوس (bachelor.php أو ما يطابقه)
        $view_file = $root_path . '/src/Views/edu-services/bachelor.php';
