...
use App\Models\GeneralVisaModel;

class GeneralVisaController {
    public function index(string $lang = 'de'): void {
        ...
        // 2. جلب بيانات صفحة متطلبات التأشيرة عبر المودل المخصص وتوفيرها بالتسميات المتوافقة
        $visa_data_array = GeneralVisaModel::getVisaData();
        $data['visa_page'] = $visa_data_array;
        $data['visa_data'] = $visa_data_array; // لضمان التوافق التام مع الحقول داخل الـ Modals والـ View
        ...
        // 2. استدعاء ملف الـ View الخاص بصفحة التأشيرة (general.php)
        $view_file = $root_path . '/src/Views/edu-services/general.php';
        ...
        if ($is_admin) {
            $modals_file = $root_path . '/src/Views/edu-services/includes/admin_general_modals.php';
