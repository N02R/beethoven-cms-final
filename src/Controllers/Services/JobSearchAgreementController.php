...
class JobSearchAgreementController {
    ...
    public function index(string $lang = 'de'): void {
        ...
        // 2. جلب بيانات صفحة اتفاقية البحث عن عمل الخاصة
        $global_settings = SiteModel::getSettings();
        $job_search_data = isset($global_settings['job_search_agreement_page']) ? json_decode($global_settings['job_search_agreement_page'], true) : [];
        
        $data['job_search_agreement_page'] = $job_search_data;
        ...
        // 2. استدعاء ملف الـ View الخاص باتفاقية البحث عن عمل (job-search-agreement.php أو ما يطابقه)
        $view_file = $root_path . '/src/Views/edu-services/job-search-agreement.php';
