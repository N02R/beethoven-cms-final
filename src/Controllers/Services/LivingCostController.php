...
class LivingCostController {
    public function index(string $lang = 'de'): void {
        ...
        // 2. جلب بيانات صفحة تكلفة المعيشة عبر المودل المخصص وتوفيرها بالتسميات المتوافقة
        $living_data_array = LivingCostModel::getLivingCostData();
        $data['living_page'] = $living_data_array;
        $data['living_data'] = $living_data_array; // لضمان التوافق التام مع الحقول داخل الـ Modals والـ View
        ...
        // 2. استدعاء ملف الـ View الخاص بتكلفة المعيشة (living.php)
        $view_file = $root_path . '/src/Views/edu-services/living.php';
        ...
        if ($is_admin) {
            $modals_file = $root_path . '/src/Views/edu-services/includes/admin_living_modals.php';
