  ...
  <div class="row">
        ...
        <ul class="nav flex-column text-end p-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#consultations-section">
              ...
              <span class="badge bg-primary ms-auto"><?php echo $data['consult_count'] ?? 0; ?></span>
            </a>
          </li>
          <li class="nav-item">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
          ...
          <div class="card card-stat p-3">
            <div class="d-flex align-items-center justify-content-between">
              <div>
                ...
                <h3 class="fw-bold text-primary mb-0"><?php echo $data['consult_count'] ?? 0; ?></h3>
              </div>
          ...
          <div class="card card-stat p-3">
            <div class="d-flex align-items-center justify-content-between">
              <div>
                ...
                <h5 class="fw-bold <?php echo ($data['ad_status'] ?? '') === 'Published' ? 'text-success' : 'text-secondary'; ?> mb-0 mt-2">
                  <?php echo ($data['ad_status'] ?? '') === 'Published' ? 'نشط الآن' : 'مسودة معطلة'; ?>
                </h5>
              </div>
            ...
            <div class="d-flex align-items-center justify-content-between">
              <div>
                ...
                <h5 class="fw-bold text-dark mb-0 mt-2">
                  <?php echo ($data['ad_type'] ?? '') === 'text' ? 'نص ديناميكي' : 'صورة بانر'; ?>
                </h5>
              </div>
          ...
          <div class="card card-stat p-3">
            <div class="d-flex align-items-center justify-content-between">
              <div>
                ...
                <h3 class="fw-bold text-dark mb-0"><?php echo $data['menu_count'] ?? 0; ?> روابط</h3>
              </div>
      ...
      <div id="consultations-section" class="card table-card mb-4 p-4">
        ...
        <?php if (!empty($data['consult_emails'])): ?>
          <div class="table-responsive">
            <table class="table table-custom align-middle mb-0">
              ...
              <tbody>
                <?php foreach ($data['consult_emails'] as $index => $item): ?>
                  <tr>
