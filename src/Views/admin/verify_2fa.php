...
<div class="container">
    <div class="login-card">
        ...
        <div class="p-4">
            ...
            <form action="/admin/verify-2fa" method="POST">
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-primary-custom mt-2">تأكيد وتسجيل الدخول</button>
            </form>
            
            <div class="text-center mt-3">
                <a href="/login" class="text-muted small text-decoration-none"><i class="bi bi-arrow-right"></i> العودة لتسجيل الدخول</a>
            </div>
        </div>
    </div>
</div>
