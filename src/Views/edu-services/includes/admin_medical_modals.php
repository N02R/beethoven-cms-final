                ...
                <form id="medicalBreadcrumbForm" method="POST" action="index.php?url=admin/settings/save">
                    ...
                    <div class="p-4 shadow-sm mb-0" style="background: #ffffff; border-radius: 16px; border: 1px solid #e2e8f0;">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="page_breadcrumb" value="<?php echo htmlspecialchars($medical_data['page_breadcrumb'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" required>
                        </div>
                        <div class="mb-0">
                            <label class="form-label fw-semibold small text-secondary">رابط المسار الأخير</label>
                            <input type="text" class="form-control" name="page_breadcrumb_url" value="<?php echo htmlspecialchars($medical_data['page_breadcrumb_url'] ?? '#', ENT_QUOTES, 'UTF-8'); ?>">
                        </div>
                    </div>
                </form>
            </div>
                ...
                <form id="medicalHeroForm" method="POST" action="index.php?url=admin/settings/save" enctype="multipart/form-data">
                    ...
                    <div class="p-4 shadow-sm mb-0" style="background: #ffffff; border-radius: 16px; border: 1px solid #e2e8f0;">
                        <?php if (!empty($medical_data['hero_img'])): ?>
                            <div class="mb-3 p-3 bg-light rounded-3 border text-center">
                                ...
                                <div class="p-1 bg-white rounded-3 border d-inline-flex align-items-center justify-content-center shadow-sm">
                                    <img src="<?php echo htmlspecialchars(get_image_url($medical_data['hero_img']), ENT_QUOTES, 'UTF-8'); ?>" style="max-height: 120px; object-fit: contain;" class="rounded-2" alt="Hero Preview">
                                </div>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="mb-0">
                            ...
                            <input type="text" class="form-control" name="hero_position" value="<?php echo htmlspecialchars($medical_data['hero_position'] ?? 'center center', ENT_QUOTES, 'UTF-8'); ?>">
                        </div>
                    </div>
                </form>
            </div>
                ...
                <form id="medicalMainForm" method="POST" action="index.php?url=admin/settings/save">
                    ...
                    <div class="p-4 shadow-sm mb-0" style="background: #ffffff; border-radius: 16px; border: 1px solid #e2e8f0;">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="main_title" value="<?php echo htmlspecialchars($medical_data['main_title'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" required>
                        </div>
                        <div class="mb-0">
                            <label class="form-label fw-semibold small text-secondary">الوصف التفصيلي</label>
                            <textarea class="form-control" name="main_desc" rows="5" style="height: auto; padding: 12px 16px;" required><?php echo htmlspecialchars($medical_data['main_desc'] ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
                        </div>
                    </div>
                </form>
            </div>
                ...
                <form id="medicalNotesForm" method="POST" action="index.php?url=admin/settings/save">
                    ...
                    <div class="p-4 shadow-sm mb-0" style="background: #ffffff; border-radius: 16px; border: 1px solid #e2e8f0;">
                        <div class="mb-0">
                            ...
                            <textarea class="form-control" name="note_text" rows="3" style="height: auto; padding: 12px 16px;" required><?php echo htmlspecialchars($medical_data['note_text'] ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
                        </div>
                    </div>
                </form>
            </div>
                    ...
                    <div class="p-4 shadow-sm mb-0" style="background: #ffffff; border-radius: 16px; border: 1px solid #e2e8f0;">
                        <div class="row g-3">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" class="form-control" name="item_title" value="<?php echo htmlspecialchars($medical_data['download_item']['title'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" required>
                            </div>
                            <div class="col-md-12">
                                <label class="form-label fw-semibold small text-secondary">النص الفرعي (Sub)</label>
                                <input type="text" class="form-control" name="item_sub" value="<?php echo htmlspecialchars($medical_data['download_item']['sub'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                            </div>
                            <div class="col-md-12">
                                ...
                                <div class="form-text text-muted mt-2 small">الملف الحالي: <?php echo htmlspecialchars($medical_data['download_item']['file'] ?? 'لا يوجد', ENT_QUOTES, 'UTF-8'); ?></div>
                            </div>
                        </div>
                    </div>
                </form>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const medicalForms = document.querySelectorAll('#medicalBreadcrumbForm, #medicalHeroForm, #medicalMainForm, #medicalNotesForm, #medicalCardForm');
