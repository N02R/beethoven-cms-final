...
<section class="guide py-5" style="position: relative;">
  ...
  <div class="custom-container">
    <div class="text-center mb-5">
      <h2 class="sec-title mb-3"><?php echo htmlspecialchars($guide_title ?? 'الدليل الشامل'); ?></h2>
            ...
            <div class="card h-100 border-0 shadow-sm">
              <?php if (!empty($item_img)): ?>
                <div class="card-img-wrapper">
                  <img src="<?php echo htmlspecialchars($item_img); ?>" alt="<?php echo htmlspecialchars($item['title'] ?? 'guide image'); ?>" class="card-img-top img-fluid">
                </div>
              <?php endif; ?>
              <div class="card-body d-flex flex-column">
                ...
                <a href="<?php echo htmlspecialchars($final_url); ?>" class="btn btn-link text-decoration-none fw-bold p-0 mt-3 d-flex align-items-center gap-2">
                  قراءة المزيد
                  <img src="<?php echo htmlspecialchars($arrow_img); ?>" alt="arrow" width="18">
                </a>
              </div>
            </div>
          </div>
