...
<footer class="footer-section pt-5">
    <div class="container-fluid custom-container">
      <div class="row gy-5">
        ...
        <div class="col-12 col-md-6 col-lg-4">
          ...
          <div class="contact-link">
            <a href="tel:+4917671230666"><img src="/assets/img/contact%20us/call-calling.svg" alt="Phone"> +49 176 71230666</a>
            <a href="mailto:info@Beethoven-City-Services.com"><img src="/assets/img/contact%20us/sms.svg" alt="Email"> info@Beethoven-City-Services.com</a>
      ...
      <div class="foot-bottom d-flex flex-column flex-md-row align-items-center justify-content-between gap-3 pb-4">
        <p class="mb-0">© جميع الحقوق محفوظة | Beethoven City Services</p>
