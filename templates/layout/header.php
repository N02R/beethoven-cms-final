<header>
    ...
    <nav id="main-header" class="navbar navbar-expand-lg py-3" aria-label="القائمة الرئيسية">
      <div class="container-fluid custom-container d-flex align-items-center justify-content-between">
        <a class="navbar-brand d-lg-none" href="/"><img src="/assets/img/logo.png" alt="شعار بيتهوفن سيتي" loading="lazy"></a>
        ...
        <div class="collapse navbar-collapse">
          <ul class="navbar-nav gap-3">
            ...
            <li class="nav-item"><a class="nav-link" href="/education">التعليم العالي</a></li>
            <li class="nav-item"><a class="nav-link" href="/job">التدريب المهني</a></li>
            <li class="nav-item"><a class="nav-link" href="/guide">دليل بيتهوفن</a></li>
